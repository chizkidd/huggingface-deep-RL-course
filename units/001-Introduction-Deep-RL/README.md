...
<div align="center">
  <video src="https://github.com/user-attachments/assets/e9d3b2e5-7097-4ccc-abf1-b3e3cb363ddc" controls="controls" style="max-width: 100%;">
  </video>
</div>
...
* **The Discount Rate ($\gamma$):** We define a discount rate called **gamma ($\gamma$)**. It must be between 0 and 1 (typically 0.95 to 0.99).
